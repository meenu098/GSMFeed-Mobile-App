    ...
    try {
      ...
      if (token && profileIdentifier) {
        try {
          ...
          const profilePlanName = String(
            json?.data?.subscription?.name || "",
          )
            .trim()
            .toLowerCase();
          if (profilePlanName) {
      ...
      {activeTab === "Suggestions" && isSuggestionAdmin ? (
        <View style={styles.filterBar}>
          ...
          >
            ...
            {activeFilterCount > 0 ? (
              <View
                style={[styles.filterCountBadge, { backgroundColor: theme.badge }]}
              >
              ...
              <>
                ...
                {pickerLoading ? (
                  ...
                  <FlatList
                    ...
                    ListEmptyComponent={() => (
                      <Text
                        style={[styles.emptyPickerText, { color: theme.subText }]}
                      >
                        No results found.
                      </Text>
                    )}
